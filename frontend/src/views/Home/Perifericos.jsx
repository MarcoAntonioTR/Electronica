    ...
    const subcategories = [
        {
            ...
            image: "../../../src/assets/ImagesPerifericos/Card1.jpg",
        },
        {
            title: "Impresoras",
            path: "/Perifericos/Impresoras",
            image: "../../../src/assets/ImagesPerifericos/Card2.jpg",
        },
        {
            title: "Monitores",
            path: "/Perifericos/Monitores",
            image: "../../../src/assets/ImagesPerifericos/Card3.jpg",
        },
        {
            title: "Ratones",
            path: "/Perifericos/Ratones",
            image: "../../../src/assets/ImagesPerifericos/Card4.jpg",
        },
        {
            title: "Teclados",
            path: "/Perifericos/Teclados",
            image: "../../../src/assets/ImagesPerifericos/Card5.jpg",
        },
    ];
    ...
    return (
        <div className={isDarkTheme ? "bg-dark text-light" : "bg-light text-dark"}>
            ...
            <div className="container py-5">
                <h2 className="my-4 text-center">Periféricos</h2>
                <div className="row">
